...
class vtkPointSetCurvatureEstimation : public vtkPolyDataAlgorithm
{
  ...
  public:
    ...
    vtkTypeRevisionMacro(vtkPointSetCurvatureEstimation, vtkPolyDataAlgorithm);
  ...
  private:
    double Radius; //The radius of the sphere used to find neighbors to use in the local plane estimation.
